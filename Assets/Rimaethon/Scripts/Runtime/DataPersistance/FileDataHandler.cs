...
public class FileDataHandler
{
    ...
    public GameSettingsData Load(string profileId, bool allowRestoreFromBackup = true)
    {
    ...
    public Dictionary<string, GameSettingsData> LoadAllProfiles()
    {
        var profileDictionary = new Dictionary<string, GameSettingsData>();
