...
namespace Rimaethon.TileMapping.com.unity._2d.tilemap.extras.Runtime.Brushes
{
    /// <summary>
    ...
    public class TintTextureGenerator : MonoBehaviour
    {
        ...
        GridInformation.GridInformation GetGridInformation(Grid grid)
        {
            GridInformation.GridInformation gridInformation = grid.GetComponent<GridInformation.GridInformation>();

            if (gridInformation == null)
                gridInformation = grid.gameObject.AddComponent<GridInformation.GridInformation>();
